    ...
    return(
        <section className={styles.sectionFounders} id='quem-somos'>
            <div className={styles.titles}>
                ...
                <div className={styles.FourdersEstruct}>
                    <div className={styles.Founder}>
                        <div className={styles.aboutFounder}>
                            <img className={styles.imgFounder} src="../../assets/png/fundador1-mobile.png" alt="fundador_1"/>
                    ...
                    <div className={styles.Founder}>
                        <div className={styles.aboutFounder}>
                            <img className={styles.imgFounder} src="../../assets/png/fundador2-mobile.png" alt="fundador_2"/>
